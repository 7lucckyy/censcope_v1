export default function DiscoverCard(properties: DiscoverCardProps) {
  return (
    ...
    >
      <span
        className={`absolute h-full w-14 translate-y-6 ${
          properties.index % 2 && "rotate-45"
        } bg-inherit group-hover:brightness-110 transition-all before:h-full before:w-full before:bg-inherit before:absolute before:-left-full before:rotate-[15deg] after:h-4/5 after:w-full after:bg-inherit after:absolute after:left-full after:top-4`}
      />
